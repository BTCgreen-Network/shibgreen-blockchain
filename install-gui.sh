...
# https://github.com/SHIBgreen-Network/shibgreen-blockchain/pull/10460#issuecomment-1054492495
...
if [ ! "$CI" ]; then
  ...
  # Set modified output of `shibgreen version` to version property of GUI's package.json
