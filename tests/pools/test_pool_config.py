...
from shibgreen.pools.pool_config import PoolWalletConfig
from shibgreen.util.config import create_default_shibgreen_config, load_config, lock_config, save_config
...
def test_pool_config(tmp_path):
    ...
    create_default_shibgreen_config(test_root, ["config.yaml"])
