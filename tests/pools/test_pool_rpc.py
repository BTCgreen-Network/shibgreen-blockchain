...
from shibgreen.pools.pool_wallet_info import PoolSingletonState, PoolWalletInfo
...
from shibgreen.wallet.derive_keys import find_authentication_sk, find_owner_sk
...
from shibgreen.simulator.block_tools import BlockTools, get_plot_dir
from tests.util.wallet_is_synced import wallet_is_synced
from shibgreen.simulator.setup_nodes import setup_simulators_and_wallets_service
...
class TestPoolWalletRpc:
    ...
    async def test_leave_pool(self, setup, trusted_and_fee, self_hostname):
        ...
        try:
            ...
            await time_out_assert(timeout=MAX_WAIT_SECS, function=have_shibgreen)
