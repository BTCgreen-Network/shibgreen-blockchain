...
from shibgreen.daemon.keychain_server import DeleteLabelRequest, SetLabelRequest
from shibgreen.daemon.server import WebSocketServer, service_plotter
...
from shibgreen.util.keychain import KeyData
from shibgreen.daemon.keychain_server import GetKeyRequest, GetKeyResponse, GetKeysResponse
...
from shibgreen.simulator.time_out_assert import time_out_assert_custom_interval, time_out_assert
...
def mock_daemon_with_services():
    ...
    return Daemon(
        services={
            ...
            "shibgreen_plotter": [Service(True), Service(True)],
        },
        connections={},
    )
