...
from shibgreen.protocols.wallet_protocol import RespondFeeEstimates
...
async def test_protocol_messages(
    wallet_node_sim_and_wallet: Tuple[
        List[Union[FullNodeAPI, FullNodeSimulator]], List[Tuple[Wallet, SHIBgreenServer]], BlockTools
    ]
) -> None:
