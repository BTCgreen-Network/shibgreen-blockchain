...
from shibgreen.data_layer.data_layer_util import NodeType, Side, Status
...
class SHIBgreenRoot:
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        kwargs["env"]["SHIBGREEN_ROOT"] = os.fspath(self.path)
        kwargs["env"]["SHIBGREEN_KEYS_ROOT"] = os.fspath(self.path)
        ...
        modified_args: List[Union[str, os_PathLike_str]] = [
            self.scripts_path.joinpath("shibgreen"),
            "--root-path",
            self.path,
            *args,
        ]
