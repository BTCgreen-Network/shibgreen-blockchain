...
from shibgreen.cmds.keys import delete_all_cmd, generate_and_print_cmd, show_cmd, sign_cmd, verify_cmd
from shibgreen.util.config import load_config
from shibgreen.util.file_keyring import FileKeyring
from shibgreen.util.keychain import DEFAULT_USER, DEFAULT_SERVICE, Keychain, generate_mnemonic
...
class TestKeysCommands:
    ...
    def empty_keyring(self):
        with TempKeyring(user="user-shibgreen-1.8", service="shibgreen-user-shibgreen-1.8") as keychain:
            yield keychain
    ...
    def test_migration_full(self, tmp_path, setup_legacy_keyringwrapper):
        ...
        current_version_str = pkg_resources.get_distribution("shibgreen-blockchain").version
    ...
    def test_migration_checked(self, tmp_path, monkeypatch):
        ...
        assert pkg_resources.get_distribution("shibgreen-blockchain").version == "1.2.11.dev123"
