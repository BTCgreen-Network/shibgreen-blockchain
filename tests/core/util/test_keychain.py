...
from shibgreen.simulator.keyring import using_temp_file_keyring
from shibgreen.util.errors import (
...
class TestKeychain(unittest.TestCase):
    ...
    def test_basic_add_delete(self):
        kc: Keychain = Keychain(user="testing-1.8.0", service="shibgreen-testing-1.8.0")
        kc.delete_all_keys()
    ...
    def test_add_private_key_label(self):
        keychain: Keychain = Keychain(user="testing-1.8.0", service="shibgreen-testing-1.8.0")
