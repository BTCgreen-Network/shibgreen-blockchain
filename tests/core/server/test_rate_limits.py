...
from shibgreen.server.rate_limit_numbers import get_rate_limits_to_use, rate_limits as rl_numbers, compose_rate_limits
...
class TestRateLimits:
    ...
    async def test_different_versions(self, node_with_params, node_with_params_b, self_hostname):
        ...
        full_node_server_a: SHIBgreenServer = node_a.full_node.server
        full_node_server_b: SHIBgreenServer = node_b.full_node.server
        ...
        a_con: WSSHIBgreenConnection = full_node_server_a.get_connections()[0]
        b_con: WSSHIBgreenConnection = full_node_server_b.get_connections()[0]
