...
class TestCATTrades:
    ...
    async def test_cat_trades(self, wallets_prefarm):
        ...
        MAKER_SHIBGREEN_BALANCE = initial_maker_balance - 100
        TAKER_SHIBGREEN_BALANCE = initial_taker_balance - 100
        await time_out_assert(25, wallet_maker.get_confirmed_balance, MAKER_SHIBGREEN_BALANCE)
        await time_out_assert(25, wallet_taker.get_unconfirmed_balance, TAKER_SHIBGREEN_BALANCE)
        ...
        # shibgreen_for_cat
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(shibgreen_for_cat, fee=uint64(1))
        await asyncio.sleep(1)
        ...
        MAKER_SHIBGREEN_BALANCE -= 2  # -1 and -1 for fee
        MAKER_NEW_CAT_BALANCE += 2
        TAKER_SHIBGREEN_BALANCE += 0  # +1 and -1 for fee
        TAKER_NEW_CAT_BALANCE -= 2

        await time_out_assert(15, wallet_taker.get_unconfirmed_balance, TAKER_SHIBGREEN_BALANCE)
        ...
        await time_out_assert(15, wallet_maker.get_confirmed_balance, MAKER_SHIBGREEN_BALANCE)
        await time_out_assert(15, wallet_maker.get_unconfirmed_balance, MAKER_SHIBGREEN_BALANCE)
        ...
        await time_out_assert(15, wallet_taker.get_confirmed_balance, TAKER_SHIBGREEN_BALANCE)
        await time_out_assert(15, wallet_taker.get_unconfirmed_balance, TAKER_SHIBGREEN_BALANCE)
        ...
        # cat_for_shibgreen
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(cat_for_shibgreen)
        assert error is None
        assert success is True
        assert trade_make is not None
        ...
        MAKER_CAT_BALANCE -= 4
        MAKER_SHIBGREEN_BALANCE += 3
        TAKER_CAT_BALANCE += 4
        TAKER_SHIBGREEN_BALANCE -= 3
        ...
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(
            shibgreen_for_multiple_cat, driver_dict=driver_dict
        )
        await asyncio.sleep(1)
        assert error is None
        assert success is True
        ...
        MAKER_SHIBGREEN_BALANCE -= 7
        MAKER_CAT_BALANCE += 8
        MAKER_NEW_CAT_BALANCE += 9
        TAKER_SHIBGREEN_BALANCE += 7
        TAKER_CAT_BALANCE -= 8
        ...
        # multiple_cat_for_shibgreen
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(multiple_cat_for_shibgreen)
        await asyncio.sleep(1)
        assert error is None
        assert success is True
        assert trade_make is not None
        ...
        MAKER_SHIBGREEN_BALANCE += 10
        TAKER_CAT_BALANCE += 11
        TAKER_NEW_CAT_BALANCE += 12
        TAKER_SHIBGREEN_BALANCE -= 10
        ...
        # shibgreen_and_cat_for_cat
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(shibgreen_and_cat_for_cat)
        await asyncio.sleep(1)
        assert error is None
        assert success is True
        assert trade_make is not None
        ...
        MAKER_SHIBGREEN_BALANCE -= 13
        MAKER_CAT_BALANCE -= 14
        MAKER_NEW_CAT_BALANCE += 15
        TAKER_SHIBGREEN_BALANCE += 13
    ...
    async def test_trade_cancellation(self, wallets_prefarm):
        ...
        xshib_to_cat_amount = uint64(100)

        async with wallet_node_maker.wallet_state_manager.lock:
            cat_wallet_maker: CATWallet = await CATWallet.create_new_cat_wallet(
                wallet_node_maker.wallet_state_manager, wallet_maker, {"identifier": "genesis_by_id"}, xshib_to_cat_amount
            )
        ...
        await time_out_assert(15, cat_wallet_maker.get_confirmed_balance, xshib_to_cat_amount)
        await time_out_assert(15, cat_wallet_maker.get_unconfirmed_balance, xshib_to_cat_amount)
        maker_funds -= xshib_to_cat_amount
        ...
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(shibgreen_for_cat)
        assert error is None
        assert success is True
        assert trade_make is not None
