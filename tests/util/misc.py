...
class _AssertRuntime:
    ...
    Produces output of the following form.
        ...
        /home/altendky/repos/shibgreen-blockchain/tests/core/full_node/test_performance.py:187
...
@contextlib.contextmanager
def closing_shibgreen_root_popen(shibgreen_root: SHIBgreenRoot, args: List[str]) -> Iterator[subprocess.Popen[Any]]:
    environment = {**os.environ, "SHIBGREEN_ROOT": os.fspath(shibgreen_root.path)}
