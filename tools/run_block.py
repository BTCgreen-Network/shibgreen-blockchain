...
"""
run_block: Convert an encoded FullBlock from the SHIBgreen blockchain into a list of transactions

As input, takes a file containing a [FullBlock](../shibgreen/types/full_block.py) in json format
...
$ca_root is the directory containing your current SHIBgreen config files
$hash is the header_hash of the [BlockRecord](../shibgreen/consensus/block_record.py)
...
The information for each spend is an "NPC" (Name, Puzzle, Condition):
        ...
        "conditions": a list of condition expressions, as in [condition_opcodes.py](../shibgreen/types/condition_opcodes.py)
...
from shibgreen.wallet.cat_wallet.cat_utils import match_cat_puzzle
from shibgreen.wallet.puzzles.load_clvm import load_serialized_clvm_maybe_recompile
from shibgreen.wallet.uncurried_puzzle import uncurry_puzzle

DESERIALIZE_MOD = load_serialized_clvm_maybe_recompile(
    "shibgreenlisp_deserialisation.clvm", package_or_requirement="shibgreen.wallet.puzzles"
)
