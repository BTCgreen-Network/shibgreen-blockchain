...
from shibgreen.cmds.init_funcs import shibgreen_init
...
from shibgreen.simulator.block_tools import make_unfinished_block
...
async def run_sync_test(
    ...
    with tempfile.TemporaryDirectory() as root_dir:
        ...
        shibgreen_init(root_path, should_check_keys=False, v1_db=(db_version == 1))
        ...
        try:
            ...
            peer: WSSHIBgreenConnection = FakePeer()  # type: ignore[assignment]
...
async def run_sync_checkpoint(
    ...
    shibgreen_init(root_path, should_check_keys=False, v1_db=False)
    config = load_config(root_path, "config.yaml")
