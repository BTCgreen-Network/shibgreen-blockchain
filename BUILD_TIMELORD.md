...
required to run a [Timelord](https://github.com/SHIBgreen-Network/shibgreen-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/SHIBgreen-Network/shibgreen-blockchain/blob/main/install-timelord.sh)
