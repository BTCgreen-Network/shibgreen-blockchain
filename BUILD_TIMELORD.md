...
required to run a [Timelord](https://github.com/BTCgreen-Network/shibgreen-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/BTCgreen-Network/shibgreen-blockchain/blob/main/install-timelord.sh)
