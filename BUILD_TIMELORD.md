...
required to run a [Timelord](https://github.com/SHIBgreenNetwork/shibgreen-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/SHIBgreenNetwork/shibgreen-blockchain/blob/main/install-timelord.sh)
