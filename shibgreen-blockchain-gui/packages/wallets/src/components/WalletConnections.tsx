import { Connection, ServiceConnectionName } from '@shibgreen/api';
import { useGetWalletConnectionsQuery } from '@shibgreen/api-react';
import { Card, FormatBytes, Loading, Table } from '@shibgreen/core';
