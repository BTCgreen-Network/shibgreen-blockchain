import { useGetCurrentAddressQuery, useGetNextAddressMutation } from '@shibgreen/api-react';
import { ButtonLoading, CopyToClipboard, Card, Loading, Flex, TooltipIcon } from '@shibgreen/core';
