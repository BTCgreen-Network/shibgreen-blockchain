import { shibgreenToMojo, AlertDialog, Amount, Fee, Back, ButtonLoading, Card, Flex, Form } from '@shibgreen/core';
  ...
  async function handleSubmit(values: CreateCATWalletData) {
    try {
      ...
      */
      ...
      const amountMojos = shibgreenToMojo(amount || '0');
  ...
  return (
    <Form methods={methods} onSubmit={handleSubmit}>
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          <Trans>Create New SHIBgreen Asset Token Wallet</Trans>
        </Back>
        <Card>
