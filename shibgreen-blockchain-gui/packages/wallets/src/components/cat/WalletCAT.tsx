...
import { useSetCATNameMutation, useGetCatListQuery } from '@shibgreen/api-react';
import { Flex, Loading, MenuItem, useOpenDialog } from '@shibgreen/core';
import { Offers as OffersIcon } from '@shibgreen/icons';
