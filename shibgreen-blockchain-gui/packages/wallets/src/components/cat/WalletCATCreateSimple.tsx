import type { CATToken } from '@shibgreen/api';
import { SyncingStatus } from '@shibgreen/api';
import { useGetWalletsQuery, useAddCATTokenMutation, useGetCatListQuery } from '@shibgreen/api-react';
import { Back, Flex, Loading, useShowError } from '@shibgreen/core';
