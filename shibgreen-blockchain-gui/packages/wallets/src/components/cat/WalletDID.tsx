import { AlertDialog, Card, Flex, Loading, Dropzone, mojoToSHIBgreenLocaleString } from '@shibgreen/core';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">{mojoToSHIBgreenLocaleString(props.balance)} TXSHIB</Typography>
        </Box>
      </Box>
    </Grid>
  );
