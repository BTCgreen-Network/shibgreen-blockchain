import { useGetSyncStatusQuery, useSendTransactionMutation, useFarmBlockMutation } from '@shibgreen/api-react';
import {
  AdvancedOptions,
  Amount,
  ButtonLoading,
...
export default function WalletSend(props: SendCardProps) {
  ...
  async function handleSubmit(data: SendTransactionData) {
    ...
    const queryData = {
      walletId,
      address,
      amount: shibgreenToMojo(amount),
      fee: shibgreenToMojo(fee),
