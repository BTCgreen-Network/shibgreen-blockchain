...
import { useGetLoggedInFingerprintQuery, useGetPrivateKeyQuery, useGetWalletsQuery } from '@shibgreen/api-react';
import {
  Flex,
  CardListItem,
  useOpenDialog,
...
export default function WalletsSidebar() {
  ...
  function handleOpenBlogPost() {
    openExternal('https://www.shib.green/cat2blog');
  }
    ...
    openDialog(
      <WalletEmptyDialog>
        <ContentStyled>
          ...
          <ActionsStyled>
            <Flex gap={3} flexDirection="column" width="100%">
              <Button
                ...
                size="large"
                onClick={() =>
                  openExternal(`https://cat1.shib.green/#publicKey=${privateKey.pk}&fingerprint=${fingerprint}`)
                }
          ...
          <Link target="_blank" href="https://www.shib.green/download/">
