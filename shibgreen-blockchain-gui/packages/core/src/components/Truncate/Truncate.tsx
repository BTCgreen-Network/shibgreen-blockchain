...
export function truncateValue(children: string, opts: TruncateValueOptions): string {
  const {
    ...
    rightLength = 4,
    splitSeparator = ':',
    prefixes = ['nft1', 'txshib1', 'xshib1', 'did:shibgreen:1', '0x'],
  } = opts;
  ...
  if (stringValue === 'did:shibgreen:19qf3g9876t0rkq7tfdkc28cxfy424yzanea29rkzylq89kped9hq3q7wd2') {
    return 'SHIBgreen Network';
  }
