...
import shibgreenToMojo from '../../utils/shibgreenToMojo';
...
export default function Amount(props: AmountProps) {
  ...
  const isSHIBgreenCurrency = ['XSHIB', 'TXSHIB'].includes(currencyCode);
  const mojo = isSHIBgreenCurrency ? shibgreenToMojo(correctedValue) : catToMojo(correctedValue);
    ...
    <FormControl variant={variant} fullWidth={fullWidth}>
      <TextField
        ...
        InputProps={{
          ...
          inputProps: {
            decimalScale: isSHIBgreenCurrency ? 12 : 3,
