...
It is an input to the [shibgreen-blockchain](https://github.com/SHIBgreen-Network/shibgreen-blockchain) repository which also includes a verifiable delay function implementation that it imports from the [chiavdf repo](https://github.com/SHIBgreen-Network/chiavdf) (in c/c++), and a proof of space implementation that it imports from the [shibgreenpos repo](https://github.com/SHIBgreen-Network/shibgreenpos). BLS signatures are imported from the [bls-signatures repo](https://github.com/SHIBgreen-Network/bls-signatures) as blspy. There is an additional dependency on the [chiabip158 repo](https://github.com/SHIBgreen-Network/chiabip158).
