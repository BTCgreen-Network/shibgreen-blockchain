  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) {currentYear} SHIBgreen Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport href="https://github.com/SHIBgreen-Network/shibgreen-blockchain/issues" target="_blank">
          Report an issue
        </BugReport>
        {'{{CSS}}'}
      </body>
