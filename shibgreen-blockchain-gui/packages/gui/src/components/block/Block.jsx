...
export default function Block() {
  ...
  const baseFarmerReward = mojoToSHIBgreen(calculateBaseFarmerReward(blockRecord.height));

  const shibgreenFees = blockRecord.fees !== undefined ? mojoToSHIBgreen(blockRecord.fees) : '';
  ...
  return (
    <LayoutDashboardSub>
      <Card
        title={
          <Back variant="h5">
            <Trans>Block at height {blockRecord.height} in the SHIBgreen blockchain</Trans>
          </Back>
        }
        action={
          <Flex gap={1}>
