import { fromBech32m } from '@shibgreen/api';
import { useSetRewardTargetsMutation, useGetRewardTargetsQuery } from '@shibgreen/api-react';
import { Button, Flex, Form, TextField, Loading } from '@shibgreen/core';
              ...
              <>
                ...
                <Typography variant="body2" color="textSecondary">
                  <Trans>
                    ...
                    and the 0.25XSHIB reward for pooling plots.
                  </Trans>
                </Typography>
              </>
            )}
