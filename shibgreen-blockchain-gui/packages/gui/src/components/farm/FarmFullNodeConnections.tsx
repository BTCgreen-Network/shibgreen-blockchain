import type { Connection } from '@shibgreen/api';
import { ServiceName } from '@shibgreen/api';
import { useGetFarmerFullNodeConnectionsQuery, useService } from '@shibgreen/api-react';
import { Table, Card, FormatBytes, FormatConnectionStatus } from '@shibgreen/core';
    ...
    <Card
      ...
      tooltip={
        <Trans>
          ...
          <Link target="_blank" href="https://github.com/SHIBgreen-Network/shibgreen-blockchain/wiki/Network-Architecture">
            Learn more
          </Link>
        </Trans>
      }
