import { useGetWalletsQuery, useCheckOfferValidityMutation } from '@shibgreen/api-react';
import { Flex, ButtonLoading, Link, Loading, useShowError } from '@shibgreen/core';
        ...
        {error ? (
          ...
          <Alert severity="error">
            <Trans>
              ...
              <Link
                target="_blank"
                href="https://shibgreenlisp.com/docs/tutorials/offers_gui_tutorial/#taker-attempts-to-accept-an-invalid-offer"
              >
                here
              </Link>{' '}
              to learn more.
