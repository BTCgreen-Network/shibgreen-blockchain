...
import { useGetWalletsQuery, useCreateOfferForIdsMutation } from '@shibgreen/api-react';
import { Flex, ButtonLoading, useOpenDialog, Loading } from '@shibgreen/core';
...
type createDefaultValuesParams = {
  walletType?: WalletType; // CAT or STANDARD_WALLET (XSHIB), indicates whether a token or CAT has a default entry
...
export function createDefaultValues(params: createDefaultValuesParams): OfferBuilderData {
  ...
  return {
    ...
    offered: {
      ...
      xshib: walletType === WalletType.STANDARD_WALLET ? [{ amount: '' }] : [],
