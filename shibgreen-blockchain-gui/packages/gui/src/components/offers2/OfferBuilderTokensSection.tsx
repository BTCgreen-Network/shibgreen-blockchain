...
import { useGetWalletsQuery } from '@shibgreen/api-react';
import { Flex, Loading, catToMojo, mojoToCATLocaleString } from '@shibgreen/core';
import { Tokens } from '@shibgreen/icons';
...
export default function OfferBuilderTokensSection(props: OfferBuilderTokensSectionProps) {
  ...
  return (
    <OfferBuilderSection
      ...
      subtitle={<Trans>SHIBgreen Asset Tokens (CATs) are tokens built on top of XSHIB</Trans>}
