import { NFTInfo } from '@shibgreen/api';
import type { Wallet } from '@shibgreen/api';
import { useGetDIDsQuery, useGetNFTWallets, useSetNFTDIDMutation } from '@shibgreen/api-react';
import {
  AlertDialog,
  Button,
  ButtonLoading,
...
export function NFTMoveToProfileAction(props: NFTMoveToProfileActionProps) {
  ...
  async function handleSubmit(formData: NFTMoveToProfileFormData) {
    ...
    const feeInMojos = shibgreenToMojo(fee || 0);
    let isValid = true;
