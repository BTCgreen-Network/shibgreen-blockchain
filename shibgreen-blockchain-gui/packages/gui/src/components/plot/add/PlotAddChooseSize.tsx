import { CardStep, ConfirmDialog, Link, Select, StateColor, useOpenDialog } from '@shibgreen/core';
    ...
    <CardStep step={step} title={<Trans>Choose Plot Size</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
          ...
          <Link target="_blank" href="https://github.com/SHIBgreen-Network/shibgreen-blockchain/wiki/k-sizes">
            Learn more
          </Link>
        </Trans>
      </Typography>
