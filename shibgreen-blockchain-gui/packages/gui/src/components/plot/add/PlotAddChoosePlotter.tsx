import { defaultPlotter, PlotterName } from '@shibgreen/api';
import type { Plotter, PlotterMap } from '@shibgreen/api';
import { useGetPlottersQuery } from '@shibgreen/api-react';
import { CardStep, Select, StateColor } from '@shibgreen/core';
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
          ...
          the default SHIBgreen Proof of Space plotter. If unsure, use the default SHIBgreen Proof of Space plotter.
        </Trans>
      </Typography>
