import { defaultPlotter, toBech32m, fromBech32m } from '@shibgreen/api';
import { useStartPlottingMutation, useCreateNewPoolWalletMutation } from '@shibgreen/api-react';
import { Back, useShowError, ButtonLoading, Flex, Form } from '@shibgreen/core';
...
export default function PlotAddForm(props: Props) {
  ...
  const methods = useForm<FormData>({
    defaultValues: defaultsForPlotter(PlotterName.SHIBGREENPOS),
  });
