import { useDeleteUnconfirmedTransactionsMutation } from '@shibgreen/api-react';
import {
  Button,
  TooltipTypography,
  Flex,
...
import { Plot as PlotIcon } from '@shibgreen/icons';
...
export default function PlotNFTCard(props: Props) {
  ...
  const rows = [
    ...
    isSelfPooling && {
      ...
      value: <UnitFormat value={mojoToSHIBgreenLocaleString(balance)} state={State.SUCCESS} />,
    },
    {
      key: 'plotsCount',
