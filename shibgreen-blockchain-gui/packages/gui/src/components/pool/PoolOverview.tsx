...
import { Flex, UnitFormat, More, Table, mojoToSHIBgreenLocaleString, Suspender } from '@shibgreen/core';
...
import { WalletStatus } from '@shibgreen/wallets';
  ...
  },
  {
    field: (nft: PlotNFT) => {
      ...
      if (state === PlotNFTStateEnum.SELF_POOLING) {
        return (
          <UnitFormat
            value={mojoToSHIBgreenLocaleString(nft.walletBalance.confirmedWalletBalance ?? 0)}
          />
        );
      }
