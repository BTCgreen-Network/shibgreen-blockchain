import { Connection } from '@shibgreen/api';
import { useGetFullNodeConnectionsQuery } from '@shibgreen/api-react';
import { Card, FormatBytes, FormatLargeNumber, Loading, Table } from '@shibgreen/core';
