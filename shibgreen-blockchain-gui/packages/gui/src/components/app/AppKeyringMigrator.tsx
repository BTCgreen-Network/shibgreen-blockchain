import { useGetKeyringStatusQuery, useMigrateKeyringMutation } from '@shibgreen/api-react';
import { Button, AlertDialog, Flex, useOpenDialog, useValidateChangePassphraseParams, Suspender } from '@shibgreen/core';
      ...
      <DialogContent>
        ...
        {canSavePassphrase && (
          <Box display="flex" alignItems="center">
            ...
            />
            <Tooltip
              title={t`Your passphrase can be stored in your system's secure credential store. SHIBgreen will be able to access your keys without prompting for your passphrase.`}
            >
