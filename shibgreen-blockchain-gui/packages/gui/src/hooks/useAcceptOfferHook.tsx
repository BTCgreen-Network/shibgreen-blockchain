import { OfferSummaryRecord } from '@shibgreen/api';
import { useTakeOfferMutation } from '@shibgreen/api-react';
import { AlertDialog, shibgreenToMojo, useOpenDialog, useShowError } from '@shibgreen/core';
...
export default function useAcceptOfferHook(): [AcceptOfferHook] {
  ...
  async function acceptOffer(
    ...
    const feeInMojos: BigNumber = fee ? shibgreenToMojo(fee) : new BigNumber(0);
