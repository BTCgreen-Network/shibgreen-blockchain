import { useGetNFTInfoQuery } from '@shibgreen/api-react';
...
export default function useNFTMinterDID(nftId: string): UseNFTMinterDIDResult {
  ...
  const [didId, hexDIDId, didName] = useMemo(() => {
    ...
    if (didId === 'did:shibgreen:19qf3g9876t0rkq7tfdkc28cxfy424yzanea29rkzylq89kped9hq3q7wd2') {
      didName = 'SHIBgreen Network';
    }
