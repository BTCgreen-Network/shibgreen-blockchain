...
import AppIcon from '../assets/img/shibgreen64x64.png';
...
// Set the userData directory to its location within SHIBGREEN_ROOT/gui
setUserDataDir();
        ...
        submenu: [
          {
            ...
            click: () => {
              openExternal('https://github.com/SHIBgreen-Network/shibgreen-blockchain/wiki');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Frequently Asked Questions' }),
            click: () => {
              openExternal('https://github.com/SHIBgreen-Network/shibgreen-blockchain/wiki/FAQ');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Release Notes' }),
            click: () => {
              openExternal('https://github.com/SHIBgreen-Network/shibgreen-blockchain/releases');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Contribute on GitHub' }),
            click: () => {
              openExternal('https://github.com/SHIBgreen-Network/shibgreen-blockchain/blob/main/CONTRIBUTING.md');
            },
          },
          {
            type: 'separator',
          },
          {
            ...
            click: () => {
              openExternal('https://github.com/SHIBgreen-Network/shibgreen-blockchain/issues');
            },
          },
          {
