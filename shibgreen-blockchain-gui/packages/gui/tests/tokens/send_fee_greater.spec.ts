...
test('Confirm that User cannot send a TXSHIB fee greater then in Wallet', async () => {
  ...
  await page.locator('text=Fee *TXSHIB >> input[type="text"]').fill('10');
  ...
  await expect(page.locator('text=Pending Change0 TXSHIB')).toBeVisible();
});
