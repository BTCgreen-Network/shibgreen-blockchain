...
If you want to learn more about this project, read the [wiki](https://github.com/BTCgreen-Network/shibgreen-blockchain/wiki), or check out the [green paper](https://www.shibgreennetwork.org/assets/SHIBgreenGreenPaper.pdf).
...
We provide a [pre-commit configuration](https://github.com/BTCgreen-Network/shibgreen-blockchain/blob/main/.pre-commit-config.yaml) which triggers several useful
...
6. Install these linters https://github.com/BTCgreen-Network/shibgreen-blockchain/tree/main/.github/linters
...
If you are not a SHIBgreen organization member, you can enquire about deploying a `beta testnet` in the public dev Discord channel.
