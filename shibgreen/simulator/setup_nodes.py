...
from shibgreen.simulator.block_tools import BlockTools, create_block_tools_async, test_constants
from shibgreen.simulator.full_node_simulator import FullNodeSimulator
from shibgreen.simulator.keyring import TempKeyring
from shibgreen.simulator.setup_services import (
    setup_daemon,
    setup_farmer,
    setup_full_node,
    setup_harvester,
...
SimulatorsAndWallets = Tuple[List[FullNodeSimulator], List[Tuple[WalletNode, SHIBgreenServer]], BlockTools]
...
) -> AsyncGenerator[Tuple[FullNodeAPI, FullNodeAPI, SHIBgreenServer, SHIBgreenServer, BlockTools], None]:
    """
...
) -> AsyncGenerator[Tuple[FullNodeAPI, WalletNode, SHIBgreenServer, SHIBgreenServer, BlockTools], None]:
