...
from shibgreen.cmds.init_funcs import init
...
from shibgreen.data_layer.data_layer_api import DataLayerAPI
from shibgreen.protocols.shared_protocol import Capability, capabilities
from shibgreen.server.start_data_layer import create_data_layer_service
from shibgreen.server.start_farmer import create_farmer_service
from shibgreen.server.start_full_node import create_full_node_service
from shibgreen.server.start_harvester import create_harvester_service
from shibgreen.server.start_introducer import create_introducer_service
from shibgreen.server.start_timelord import create_timelord_service
from shibgreen.server.start_wallet import create_wallet_service
from shibgreen.simulator.block_tools import BlockTools
from shibgreen.simulator.keyring import TempKeyring
from shibgreen.simulator.start_simulator import create_full_node_simulator_service
...
async def setup_wallet_node(
    ...
    with TempKeyring(populate=True) as keychain:
        ...
        service_config["xshib_spam_amount"] = xshib_spam_amount
...
async def setup_farmer(
    ...
    service_config["xshib_target_address"] = encode_puzzle_hash(b_tools.farmer_ph, "xshib")
