...
from shibgreen.cmds.show_funcs import show_async
...
def show_cmd(
    ...
    if connections:
        print("'shibgreen show -c' has been renamed to 'shibgreen peer -c' ")
    if add_connection != "":
        print("'shibgreen show -a' has been renamed to 'shibgreen peer -a' ")
    if remove_connection != "":
        print("'shibgreen show -r' has been renamed to 'shibgreen peer -r' ")
    if wallet_rpc_port is not None:
        print("'shibgreen show -wp' is not used, please remove it from your command.")
    asyncio.run(
        show_async(
            rpc_port,
            ctx.obj["root_path"],
