...
@click.option(
    ...
    "-d",
    help=(
        "Show the first wallet address using non-observer derivation. Older SHIBgreen versions use "
...
@keys_cmd.command("migrate", short_help="Attempt to migrate keys to the SHIBgreen keyring")
@click.pass_context
...
@click.option("--prefix", "-x", help="Address prefix (xshib for mainnet, txshib for testnet)", default=None, type=str)
@click.pass_context
def search_cmd(
    ctx: click.Context,
