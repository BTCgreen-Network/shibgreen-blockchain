...
from shibgreen.util.errors import KeychainMaxUnlockAttempts
from shibgreen.util.keychain import Keychain, supports_os_passphrase_storage
from shibgreen.util.keyring_wrapper import DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE, KeyringWrapper
...
def read_passphrase_from_file(passphrase_file: TextIOWrapper) -> str:
    passphrase = passphrase_file.read().rstrip(os.environ.get("SHIBGREEN_PASSPHRASE_STRIP_TRAILING_CHARS", "\r\n"))
