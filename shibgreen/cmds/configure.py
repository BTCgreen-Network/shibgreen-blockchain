...
from shibgreen.util.config import lock_and_load_config, save_config, str2bool
    ...
    with lock_and_load_config(root_path, "config.yaml") as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_dns_introducer = "dns-introducer-testnet0.shib.green"
                bootstrap_peers = ["testnet0-node.shib.green"]
                testnet = "testnet0"
