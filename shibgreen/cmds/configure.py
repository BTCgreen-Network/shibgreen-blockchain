...
def configure(
    ...
    if testnet:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "56888"
            testnet_introducer = "introducer-testnet10.shibgreennetwork.org"
            testnet_dns_introducer = "dns-introducer-testnet10.shibgreennetwork.org"
            bootstrap_peers = ["testnet10-node.shibgreen.com"]
            testnet = "testnet10"
