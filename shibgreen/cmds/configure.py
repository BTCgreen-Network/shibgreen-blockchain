...
from shibgreen.util.config import load_defaults_for_missing_services, lock_and_load_config, save_config, str2bool
    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "57442"
                testnet_introducer = "introducer-testnet10.shib.green"
                testnet_dns_introducer = "dns-introducer-testnet10.shib.green"
                bootstrap_peers = ["testnet10-node.shib.green"]
                testnet = "testnet10"
                ...
                mainnet_port = "7442"
                mainnet_introducer = "introducer.shib.green"
                mainnet_dns_introducer = "dns-introducer.shib.green"
                bootstrap_peers = ["node.shib.green"]
                net = "mainnet"
