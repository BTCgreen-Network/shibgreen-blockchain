...
from shibgreen.util.config import get_config_lock, load_config, save_config, str2bool
    ...
    with get_config_lock(root_path, "config.yaml"):
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "58444"
                testnet_introducer = "introducer-testnet10.shibgreen.net"
                testnet_dns_introducer = "dns-introducer-testnet10.shibgreen.net"
                bootstrap_peers = ["testnet10-node.shibgreen.net"]
                testnet = "testnet10"
            ...
            bootstrap_peers = ["node.shibgreen.com"]
            net = "mainnet"
