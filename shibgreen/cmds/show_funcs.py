...
async def print_blockchain_state(node_client: FullNodeRpcClient, config: Dict[str, Any]) -> bool:
    ...
    if synced:
        ...
        print("You may be able to expedite with 'shibgreen peer full_node -a host:port' using a known node.\n")
...
async def show_async(
    ...
    from shibgreen.cmds.cmds_util import get_any_service_client
