...
from shibgreen.seeder.crawl_store import CrawlStore
from shibgreen.seeder.peer_record import PeerRecord, PeerReliability
...
class Crawler:
    ...
    async def connect_task(self, peer):
        async def peer_action(peer: WSSHIBgreenConnection):
    ...
    async def new_peak(self, request: full_node_protocol.NewPeak, peer: WSSHIBgreenConnection):
        try:
            peer_info = peer.get_peer_info()
