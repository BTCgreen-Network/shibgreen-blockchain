...
class CrawlerAPI:
    ...
    async def request_peers(self, _request: full_node_protocol.RequestPeers, peer: WSSHIBgreenConnection):
        pass
    ...
    @api_request(peer_required=True)
    async def new_peak(self, request: full_node_protocol.NewPeak, peer: WSSHIBgreenConnection) -> Optional[Message]:
    ...
    @api_request(peer_required=True)
    async def new_compact_vdf(self, request: full_node_protocol.NewCompactVDF, peer: WSSHIBgreenConnection):
        pass
