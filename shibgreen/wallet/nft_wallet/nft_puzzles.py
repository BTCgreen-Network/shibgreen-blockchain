...
from shibgreen.wallet.nft_wallet.nft_info import NFTCoinInfo, NFTInfo
...
from shibgreen.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import solution_for_conditions
...
def metadata_to_program(metadata: Dict[bytes, Any]) -> Program:
    """
    Convert the metadata dict to a SHIBgreenlisp program
    :param metadata: User defined metadata
    :return: SHIBgreenlisp program
    """
    kv_list = []
...
def program_to_metadata(program: Program) -> Dict[bytes, Any]:
    ...
    :param program: SHIBgreenlisp program contains the metadata
