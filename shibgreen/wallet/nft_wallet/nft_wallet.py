...
from shibgreen.wallet.trading.offer import OFFER_MOD, NotarizedPayment, Offer
...
class NFTWallet:
    ...
    async def coin_added(self, coin: Coin, height: uint32, in_transaction: bool) -> None:
        ...
        full_nodes: Dict[bytes32, WSSHIBgreenConnection] = server.connection_by_type.get(NodeType.FULL_NODE, {})
