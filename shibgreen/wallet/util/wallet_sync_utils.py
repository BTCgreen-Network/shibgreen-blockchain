...
from shibgreen.types.blockchain_format.coin import hash_coin_list, Coin
...
async def request_and_validate_additions(
    peer: WSSHIBgreenConnection, height: uint32, header_hash: bytes32, puzzle_hash: bytes32, additions_root: bytes32
):
...
async def _fetch_header_blocks_inner(
    all_peers: List[WSSHIBgreenConnection],
