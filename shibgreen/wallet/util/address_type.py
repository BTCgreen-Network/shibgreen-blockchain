...
from shibgreen.util.config import selected_network_address_prefix
...
class AddressType(Enum):
    ...
    def hrp(self, config: Dict[str, Any]) -> str:
        if self == AddressType.XSHIB:
            # Special case to map XSHIB to the current network's address prefix
