...
from shibgreen.protocols.wallet_protocol import CoinState, PuzzleSolutionResponse, RespondPuzzleSolution
...
from shibgreen.util.config import process_config_start_method
...
from shibgreen.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_wallet_sk_unhardened
from shibgreen.wallet.did_wallet.did_info import DID_HRP
...
from shibgreen.wallet.puzzles.cat_loader import CAT_MOD
...
from shibgreen.wallet.util.wallet_sync_utils import last_change_height_cs
...
from shibgreen.wallet.wallet_weight_proof_handler import WalletWeightProofHandler
...
class WalletStateManager:
    ...
    async def new_coin_state(
        self, coin_states: List[CoinState], peer: WSSHIBgreenConnection, fork_height: Optional[uint32]
    ) -> None:
