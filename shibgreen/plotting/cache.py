...
from shibgreen.plotting.util import parse_plot_info
from shibgreen.types.blockchain_format.proof_of_space import generate_plot_public_key
from shibgreen.types.blockchain_format.sized_bytes import bytes32
from shibgreen.util.ints import uint16, uint64
from shibgreen.util.misc import VersionedBlob
        ...
        try:
            ...
            if stored_cache.version == CURRENT_VERSION:
                ...
                for path, cache_entry in cache_data.entries:
                    ...
                    #       Related: - https://github.com/SHIBgreen-Network/shibgreen-blockchain/issues/13084
                    #                - https://github.com/SHIBgreen-Network/chiapos/pull/337
                    ...
                    # See https://github.com/SHIBgreen-Network/chiapos/blob/3ee062b86315823dd775453ad320b8be892c7df3/src/prover_disk.hpp#L282-L287  # noqa: E501
