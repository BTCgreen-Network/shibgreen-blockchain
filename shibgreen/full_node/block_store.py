...
from shibgreen.util.db_wrapper import DBWrapper2, execute_fetchone
from shibgreen.util.errors import Err
from shibgreen.util.full_block_utils import block_info_from_block, generator_from_block
from shibgreen.util.ints import uint32
from shibgreen.util.lru_cache import LRUCache
from shibgreen.util.full_block_utils import GeneratorBlockInfo
    ...
    async def create(cls, db_wrapper: DBWrapper2) -> BlockStore:
        ...
        async with self.db_wrapper.writer_maybe_transaction() as conn:
            ...
            if self.db_wrapper.db_version == 2:
                ...
                # in the shibgreen/cmds/db_upgrade.py file
