...
if os.path.exists(f"{ROOT}/madmax/shibgreen_plot"):
    binaries.extend([
        (
...
if os.path.exists(f"{ROOT}/madmax/shibgreen_plot_k34",):
    binaries.extend([
        (
...
add_binary("start_data_layer_http", f"{ROOT}/shibgreen/data_layer/data_layer_server.py", COLLECT_ARGS)
