...
from shibgreen.pools.pool_config import PoolWalletConfig, load_pool_config, add_auth_key
...
from shibgreen.util.config import load_config, save_config, config_path_for_filename, get_config_lock
...
class Farmer:
    ...
    async def get_cached_harvesters(self, connection: WSSHIBgreenConnection) -> HarvesterCacheEntry:
