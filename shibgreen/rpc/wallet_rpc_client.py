...
from shibgreen.data_layer.data_layer_wallet import Mirror, SingletonRecord
...
class WalletRpcClient(RpcClient):
    ...
    async def nft_mint_bulk(
        ...
        xshib_coins: Optional[List[Dict]] = None,
        xshib_change_target: Optional[str] = None,
        ...
        request = {
            ...
            "xshib_change_target": xshib_change_target,
