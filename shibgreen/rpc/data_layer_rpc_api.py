...
from shibgreen.data_layer.data_layer_wallet import DataLayerWallet, Mirror, verify_offer
from shibgreen.rpc.data_layer_rpc_util import marshal
from shibgreen.rpc.rpc_server import Endpoint, EndpointResult
...
class DataLayerRpcApi:
    ...
    def __init__(self, data_layer: DataLayer):  # , wallet: DataLayerWallet):
        ...
        self.service_name = "shibgreen_data_layer"
