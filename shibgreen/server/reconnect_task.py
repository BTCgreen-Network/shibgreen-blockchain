...
from shibgreen.util.network import get_host_addr


def start_reconnect_task(server: SHIBgreenServer, peer_info_arg: PeerInfo, log, auth: bool, prefer_ipv6: Optional[bool]):
    """
