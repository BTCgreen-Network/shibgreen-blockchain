...
from shibgreen.plot_sync.exceptions import (
...
from shibgreen.server.ws_connection import ProtocolMessageTypes, WSSHIBgreenConnection, make_msg
...
class Receiver:
    _connection: WSSHIBgreenConnection
    _current_sync: Sync
    _last_sync: Sync
    ...
    def connection(self) -> WSSHIBgreenConnection:
