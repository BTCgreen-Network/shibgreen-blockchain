...
from shibgreen.plot_sync.exceptions import AlreadyStartedError, InvalidConnectionTypeError
...
from shibgreen.server.ws_connection import NodeType, ProtocolMessageTypes, WSSHIBgreenConnection, make_msg
from shibgreen.util.generator_tools import list_to_batches
from shibgreen.util.ints import int16, uint32, uint64
...
class Sender:
    ...
    _connection: Optional[WSSHIBgreenConnection]
    _sync_id: uint64
    ...
    def set_connection(self, connection: WSSHIBgreenConnection) -> None:
