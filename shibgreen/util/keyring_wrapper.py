...
def check_legacy_keyring_keys_present(keyring: LegacyKeyring) -> bool:
    ...
    from shibgreen.util.keychain import MAX_KEYS, default_keychain_service, default_keychain_user, get_private_key_user
...
class KeyringWrapper:
    ...
    def __init__(self, keys_root_path: Path = DEFAULT_KEYS_ROOT_PATH, force_legacy: bool = False):
        ...
        """
        from shibgreen.util.errors import KeychainNotSet
    ...
    def set_master_passphrase(
        ...
        *,
        ...
        """
        from shibgreen.util.errors import KeychainCurrentPassphraseIsInvalid, KeychainRequiresMigration
        from shibgreen.util.keychain import supports_os_passphrase_storage
    ...
    def migrate_legacy_keys(self) -> MigrationResults:
        from shibgreen.util.keychain import MAX_KEYS, Keychain, get_private_key_user
