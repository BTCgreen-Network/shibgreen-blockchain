...
export SHIBGREEN_INSTALLER_VERSION
...
pip install j2cli
CLI_DEB_BASE="shibgreen-blockchain-cli_$SHIBGREEN_INSTALLER_VERSION-1_$PLATFORM"
mkdir -p "dist/$CLI_DEB_BASE/opt/shibgreen"
mkdir -p "dist/$CLI_DEB_BASE/usr/bin"
mkdir -p "dist/$CLI_DEB_BASE/DEBIAN"
j2 -o "dist/$CLI_DEB_BASE/DEBIAN/control" assets/deb/control.j2
cp -r dist/daemon/* "dist/$CLI_DEB_BASE/opt/shibgreen/"
ln -s ../../opt/shibgreen/shibgreen "dist/$CLI_DEB_BASE/usr/bin/shibgreen"
...
if [ "$PLATFORM" = "arm64" ]; then
  ...
  echo USE_SYSTEM_FPM=true electron-builder build --linux deb --arm64 \
    ...
    --config.deb.packageName="shibgreen-blockchain"
...
GUI_DEB_NAME=shibgreen-blockchain_${SHIBGREEN_INSTALLER_VERSION}_${PLATFORM}.deb
mv "dist/${PRODUCT_NAME}-${SHIBGREEN_INSTALLER_VERSION}.deb" "../../../build_scripts/dist/${GUI_DEB_NAME}"
